           ...
           <h3>Responsive Mega Menu</h3> 
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <a class="vc_btn" href="features-mega-menu.php">View All Examples of Mega Menu &nbsp;<i class=" icon-chevron-sign-right"></i></a>                            </div>                                                                         
            </div>                                            
        </div> <!-- child-menu -->                      
      </div>   <!-- vc_mega-menu -->                 
    </li>                
      ...
      <div class="vc_menu-open-right vc_menu-2-v">
        <ul class="clearfix">
          ...
          <li class="dropdown"> <a href="#"> 3rd Level <i class="icon-caret-right"></i> </a>
            <div class="vc_menu-open-right vc_menu-2-v">
              <ul class="clearfix">
                <li  class="dropdown"> <a href="#"> 4th Level <i class="icon-caret-right"></i> </a> 
                    <div class="vc_menu-open-right vc_menu-2-v">
                      <ul class="clearfix">
    ...
    <li id="pages"> <a href="pages-team-members.php">ความรัก &amp;แต่งงาน</a>
      <div class="vc_menu-open-left vc_menu-2-v">
        <ul class="clearfix">
          ...
          <li class="dropdown"> <a href="pages-full-width.php"> Page Layout <i class="icon-caret-right"></i> </a>
            <div class="vc_menu-open-right vc_menu-2-v">
              <ul class="clearfix">
